...
// Coaching sample: 4 reviewed calls (2 from Apr 20, 1 from Apr 21, 1 from Apr 22)
...
const reportHistory = [
  {
    ...
    trendHeadline: 'Sales 8 on pace · Conv 8.51% · 4 reviewed calls',
    scoreNote: 'Pace holding · emotional-resistance surrender pattern to tighten',
    href: '/agents/lawrence-morris/reports/2026-04-22',
  },
]
      ...
      <div className={styles.page}>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total is 8 sales / 94 calls — this is a coaching sample, not an audit of every call.
          </p>
          {showAllCalls && (
            <>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Lawrence Morris · Weekly Brief · April 22, 2026</p>
        </div>
