...
// This page is a permanent archive of the Apr 22 brief delivered to Jeri.
    ...
    calls: [
      {
        ...
        type: 'Money Caller · C-SNP · MOV SEP · soft yes cooled during silence',
...
export default function JeriVivasApr22ReportPage() {
  ...
  return (
    <PageShell signal="yellow">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/jeri-vivas" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Jeri Vivas
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Jeri Vivas — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            This is the call pulled for coaching this period. CRM total was 1 sale / 31 calls — a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Jeri Vivas · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
