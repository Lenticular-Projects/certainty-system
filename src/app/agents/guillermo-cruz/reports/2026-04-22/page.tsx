...
// Permanent archive of the Apr 22 brief delivered to Guillermo.
...
export default function GuillermoCruzApr22ReportPage() {
  ...
  return (
    <PageShell signal="green">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/guillermo-cruz" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Guillermo Cruz
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Guillermo Cruz — April 22, 2026</h1>
        ...
        <motion.div className={styles.trendSnapshot} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginTop: '14px', lineHeight: 1.65 }}>
            5 sales in 3 days — <strong style={{ color: 'var(--sage-dark)' }}>you already beat last week&apos;s 5-day total with two days left.</strong> Conversion more than doubled (4.76% → 9.80%) and CPA dropped $117. The coaching focus is on converting the calls where you did the hard work — built rapport, ran discovery, found the right plan — and surrendered before asking for the business. Tighten that seam and this pace compounds.
          </p>
        </motion.div>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 5 sales / 51 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Guillermo Cruz · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
