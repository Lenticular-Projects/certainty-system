...
// Permanent archive of the Apr 22 brief delivered to Manuel.
// CRM (source of truth):
...
export default function ManuelMedranoApr22ReportPage() {
  ...
  return (
    <PageShell signal="yellow">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/manuel-medrano" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Manuel Medrano
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Manuel Medrano — April 22, 2026</h1>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Manuel Medrano · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
