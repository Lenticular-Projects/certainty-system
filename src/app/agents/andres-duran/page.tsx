...
// Coaching sample: 8 reviewed calls (3 from Apr 20, 3 from Apr 21, 2 from Apr 22)
...
const reportHistory = [
  {
    ...
    trendHeadline: 'Sales 8 on pace · Conv 9.20% · 8 reviewed calls',
    scoreNote: 'Pace holding · close-sequence gap · SEP anchor discipline',
    href: '/agents/andres-duran/reports/2026-04-22',
  },
]
      ...
      <div className={styles.page}>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total this period is 8 sales / 87 calls — this is a coaching sample, not an audit of every call.
          </p>
          {showAllCalls && (
            <>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Andres Duran · Weekly Brief · April 22, 2026</p>
        </div>
