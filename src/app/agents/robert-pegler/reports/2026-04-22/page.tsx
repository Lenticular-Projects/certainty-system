...
// Permanent archive of the Apr 22 brief delivered to Robert.
// CRM (source of truth):
...
export default function RobertPeglerApr22ReportPage() {
  ...
  return (
    <PageShell signal="red">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/robert-pegler" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Robert Pegler
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Robert Pegler — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 2 sales / 62 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Robert Pegler · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
