...
// This page is a permanent archive of the Apr 22 brief delivered to Ashley.
...
export default function AshleyWhitehurstApr22ReportPage() {
  ...
  return (
    <PageShell signal="yellow">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/ashley-whitehurst" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Ashley Whitehurst
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Ashley Whitehurst — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 8 sales / 95 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Ashley Whitehurst · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
