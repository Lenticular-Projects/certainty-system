...
// Permanent archive of the Apr 22 brief delivered to Tavares.
// CRM (source of truth):
...
const whatToWorkOn = [
  ...
  },
  {
    ...
    script: '"Freddie — all 11 of your medications. Every single one. Covered. That table full of medicines — same coverage, same Walgreens on 288. Nothing changes except your specialist copays go down $30 a visit. That\'s what we did today."',
  },
  {
    num: 3,
...
export default function TavaresSmithApr22ReportPage() {
  ...
  return (
    <PageShell signal="green">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/tavares-smith" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Tavares Smith
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Tavares Smith — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 3 sales / 61 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Tavares Smith · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
