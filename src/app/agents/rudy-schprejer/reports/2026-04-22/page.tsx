...
// Permanent archive of the Apr 22 brief delivered to Rudy.
// CRM (source of truth):
...
const reviewedCalls = [
  {
    ...
    calls: [
      { consumer: 'Brian Bursley', duration: '53:40', score: 72, outcome: 'ENROLLED',          type: 'IEP First-Timer · $184.70 give-back · extra month won',           href: '/agents/rudy-schprejer/calls/brian-bursley' },
      { consumer: 'Mary',          duration: '57:55', score: 41, outcome: 'MISSED OPPORTUNITY', type: 'D-SNP · doctor lookup stall · recovery window missed',            href: '/agents/rudy-schprejer/calls/mary' },
    ],
  },
  {
    ...
    calls: [
      ...
      { consumer: 'Santiago Ramos', duration: '09:04', score: 48, outcome: 'MISSED OPPORTUNITY', type: 'Self-created objection · Devoted-as-BCBS misidentification',      href: '/agents/rudy-schprejer/calls/santiago-ramos' },
    ],
  },
  {
    date: 'Wednesday, April 22',
    calls: [
      { consumer: 'Florentina', duration: '02:33', score: 19, outcome: 'MISSED OPPORTUNITY', type: 'Food card caller · PII fear signal · ultimatum instead of trust bridge', href: '/agents/rudy-schprejer/calls/florentina' },
    ],
  },
]
...
export default function RudySchprejerApr22ReportPage() {
  ...
  return (
    <PageShell signal="green">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/rudy-schprejer" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Rudy Schprejer
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Rudy Schprejer — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 7 sales / 50 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Rudy Schprejer · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
