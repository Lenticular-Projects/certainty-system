      ...
      <div className={styles.page}>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <div style={{ background: 'rgba(251,248,243,0.82)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.5)', borderRadius: '12px', overflow: 'hidden', boxShadow: 'var(--shadow-sm)' }}>
            ...
            {([
              { metric: 'Sales',       prior: '5',     current: '8',      delta: '+3',       dir: 'up' },
              { metric: 'Conversion',  prior: '7.04%', current: '7.48%',  delta: '+0.44pp',  dir: 'up' },
              { metric: 'CPA',         prior: '$185',  current: '$183',   delta: '−$2',      dir: 'up' },
              { metric: 'Total Calls', prior: '71',    current: '107',    delta: '+36',      dir: 'neutral' },
