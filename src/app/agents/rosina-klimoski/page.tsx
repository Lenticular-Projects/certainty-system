...
// Coaching sample: 1 reviewed call (Anna Lyon, Apr 21)
// Honest framing: low volume week (35 calls in 3 days vs 115 in 5 last week) AND
// efficiency drop — pace is 11.7 calls/day this period vs 23/day last week, and
// the conversion that did happen came in at less than half last week's rate.
...
const reportHistory = [
  {
    ...
    trendHeadline: 'Sales 1 · Conv 2.86% · CPA $430',
    scoreNote: 'Low volume (35 calls / 3 days) · Client Gold deployment gap',
    href: '/agents/rosina-klimoski/reports/2026-04-22',
  },
]
      ...
      <div className={styles.page}>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            This is the call we pulled for coaching this period. Your CRM total this period is 1 sale / 35 calls — this is a coaching sample, not an audit of every call.
          </p>
          {showAllCalls && (
            <>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Rosina Klimoski · Weekly Brief · April 22, 2026</p>
        </div>
