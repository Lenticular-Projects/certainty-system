...
// Permanent archive of the Apr 22 brief delivered to Karimah.
...
export default function KarimahAliApr22ReportPage() {
    ...
    <PageShell signal="green">
      <div className={styles.page}>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Karimah Ali — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 7 sales / 63 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Karimah Ali · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
