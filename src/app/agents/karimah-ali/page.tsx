      ...
      <div className={styles.page}>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <div style={{ background: 'rgba(251,248,243,0.82)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.5)', borderRadius: '12px', overflow: 'hidden', boxShadow: 'var(--shadow-sm)' }}>
            ...
            {([
              { metric: 'Sales',       prior: '11',    current: '14',     delta: '+3',       dir: 'up' },
              { metric: 'Conversion',  prior: '10.68%', current: '14.89%', delta: '+4.21pp', dir: 'up' },
              { metric: 'CPA',         prior: '$108',  current: '$84',    delta: '−$24',     dir: 'up' },
              { metric: 'Total Calls', prior: '103',   current: '94',     delta: '−9',       dir: 'neutral' },
