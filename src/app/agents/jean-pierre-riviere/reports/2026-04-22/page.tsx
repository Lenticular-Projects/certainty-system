...
// Permanent archive of the Apr 22 brief delivered to Jean Pierre.
// CRM (source of truth):
...
export default function JeanPierreRiviereApr22ReportPage() {
  ...
  return (
    <PageShell signal="green">
      <div className={styles.page}>
        ...
        {/* Breadcrumb */}
        <Link href="/agents/jean-pierre-riviere" style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', textDecoration: 'none', display: 'inline-block', marginBottom: '24px' }}>
          ← Back to Jean Pierre Riviere
        </Link>
        ...
        <motion.div className={styles.header} {...SPRING}>
          ...
          <h1 className={styles.agentName}>Jean Pierre Riviere — April 22, 2026</h1>
        ...
        <motion.div className={styles.section} {...SPRING}>
          ...
          <p style={{ fontSize: '0.8125rem', color: 'var(--ink-60)', marginBottom: '16px', fontStyle: 'italic' }}>
            These are the calls we pulled for coaching this period. Your CRM total was 6 sales / 83 calls — this was a coaching sample, not an audit of every call.
          </p>
        ...
        <div className={styles.footer}>
          <p>The Certainty System · Jean Pierre Riviere · Weekly Brief · April 22, 2026 · Archived</p>
        </div>
